...
<body>
<center>
	<h1 style="color:blue;font-size:30px">Transfer Form</h1>
	<form action="Transfer"><br><br>
		<p style="font-size:20px">
			Target Accno<span style="color:red">*</span> : <input type="text" name="taccno" required="required" style="font-size:20px"><br><br>
